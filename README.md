...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/IovAnto/LC-3_Verilog/main/media/datapath-mocha.svg">
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/IovAnto/LC-3_Verilog/main/media/datapath-latte.svg">
  <img alt="Datapath diagram: the fetch, decode and execute cycle moves through the program counter, memory address register, RAM, instruction register, control FSM, ALU and register file" src="https://raw.githubusercontent.com/IovAnto/LC-3_Verilog/main/media/datapath-latte.svg">
</picture>

The diagram above is generated by [`tools/gen_datapath.py`](tools/gen_datapath.py) and
animates one full instruction cycle. It is an SVG, so it stays sharp at any size and
carries no bitmap.
